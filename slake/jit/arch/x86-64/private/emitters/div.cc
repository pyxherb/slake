...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitDiv8WithReg8Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RDX:
		case REG_RBX: {
			DEF_INS_BUFFER(insBuf, 0xf6, MODRM_BYTE(0b11, 6, (registerId - REG_RAX)));
		...
		case REG_RSI:
		case REG_RDI: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(0, 0, 0, 0), 0xf6, MODRM_BYTE(0b11, 6, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_R8:
		case REG_R9:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(0, 0, 0, 1), 0xf6, MODRM_BYTE(0b11, 6, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitDiv16WithReg16Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RSI:
		case REG_RDI: {
			DEF_INS_BUFFER(insBuf, 0x66, 0xf7, MODRM_BYTE(0b11, 6, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_R8:
		case REG_R9:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, 0x66, REX_PREFIX(0, 0, 0, 1), 0xf7, MODRM_BYTE(0b11, 6, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
			throw std::logic_error("Invalid register ID");
...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitDiv32WithReg32Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RSI:
		case REG_RDI: {
			DEF_INS_BUFFER(insBuf, 0xf7, MODRM_BYTE(0b11, 6, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_R8:
		case REG_R9:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(0, 0, 0, 1), 0xf7, MODRM_BYTE(0b11, 6, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
			throw std::logic_error("Invalid register ID");
...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitDiv64WithReg64Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RSI:
		case REG_RDI: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(1, 0, 0, 0), 0xf7, MODRM_BYTE(0b11, 6, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_R8:
		case REG_R9:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(1, 0, 0, 1), 0xf7, MODRM_BYTE(0b11, 6, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
			throw std::logic_error("Invalid register ID");
...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitIdiv8WithReg8Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RDX:
		case REG_RBX: {
			DEF_INS_BUFFER(insBuf, 0xf6, MODRM_BYTE(0b11, 7, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_RSP:
		case REG_RBP:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(0, 0, 0, 1), 0xf6, MODRM_BYTE(0b11, 7, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
			throw std::logic_error("Invalid register ID");
...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitIdiv16WithReg16Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RSI:
		case REG_RDI: {
			DEF_INS_BUFFER(insBuf, 0x66, 0xf7, MODRM_BYTE(0b11, 7, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_R8:
		case REG_R9:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, 0x66, REX_PREFIX(0, 0, 0, 1), 0xf7, MODRM_BYTE(0b11, 7, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
			throw std::logic_error("Invalid register ID");
...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitIdiv32WithReg32Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RSI:
		case REG_RDI: {
			DEF_INS_BUFFER(insBuf, 0xf7, MODRM_BYTE(0b11, 7, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_R8:
		case REG_R9:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(0, 0, 0, 1), 0xf7, MODRM_BYTE(0b11, 7, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
			throw std::logic_error("Invalid register ID");
...
SLAKE_API DiscreteInstruction slake::jit::x86_64::emitIdiv64WithReg64Ins(RegisterId registerId) {
	switch (registerId) {
		...
		case REG_RSI:
		case REG_RDI: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(1, 0, 0, 0), 0xf7, MODRM_BYTE(0b11, 7, (registerId - REG_RAX)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		case REG_R8:
		case REG_R9:
		...
		case REG_R14:
		case REG_R15: {
			DEF_INS_BUFFER(insBuf, REX_PREFIX(1, 0, 0, 1), 0xf7, MODRM_BYTE(0b11, 7, (registerId - REG_R8)));
			return emitRawIns(sizeof(insBuf), insBuf);
		}
		default:
			throw std::logic_error("Invalid register ID");
