...
namespace slake {
	...
	public:
		...
		SLAKE_API virtual void fill(size_t beginIndex, size_t length, const Value &value) = 0;
	...
	public:
		...
		SLAKE_API virtual void fill(size_t beginIndex, size_t length, const Value &value) override;
