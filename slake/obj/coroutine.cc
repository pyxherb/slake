...
SLAKE_API CoroutineObject::CoroutineObject(Runtime *rt, peff::Alloc *selfAllocator) : Object(rt, selfAllocator, ObjectKind::Coroutine), curContext(nullptr), curMajorFrame(nullptr), overloading(nullptr), stackData(nullptr), lenStackData(0), offStackTop(0), offRegs(0) {
}
