...
#define SLAKE_OPCODE_ENTRIES        \
	SLAKE_OPCODE_ENTRY(LVALUEI8)    \
	SLAKE_OPCODE_ENTRY(LVALUEI16)   \
	SLAKE_OPCODE_ENTRY(LVALUEI32)   \
	SLAKE_OPCODE_ENTRY(LVALUEI64)   \
	SLAKE_OPCODE_ENTRY(LVALUEISIZE) \
	SLAKE_OPCODE_ENTRY(LVALUEU8)    \
	SLAKE_OPCODE_ENTRY(LVALUEU16)   \
	SLAKE_OPCODE_ENTRY(LVALUEU32)   \
	SLAKE_OPCODE_ENTRY(LVALUEU64)   \
	SLAKE_OPCODE_ENTRY(LVALUEUSIZE) \
	SLAKE_OPCODE_ENTRY(LVALUEF32)   \
	SLAKE_OPCODE_ENTRY(LVALUEF64)   \
	SLAKE_OPCODE_ENTRY(LVALUEBOOL)  \
	SLAKE_OPCODE_ENTRY(LVALUE)      \
                                    \
	SLAKE_OPCODE_ENTRY(STOREI8)       \
	SLAKE_OPCODE_ENTRY(STOREI16)       \
	SLAKE_OPCODE_ENTRY(STOREI32)       \
	SLAKE_OPCODE_ENTRY(STOREI64)       \
	SLAKE_OPCODE_ENTRY(STOREISIZE)       \
	SLAKE_OPCODE_ENTRY(STOREU8)       \
	SLAKE_OPCODE_ENTRY(STOREU16)       \
	SLAKE_OPCODE_ENTRY(STOREU32)       \
	SLAKE_OPCODE_ENTRY(STOREU64)       \
	SLAKE_OPCODE_ENTRY(STOREUSIZE)       \
	SLAKE_OPCODE_ENTRY(STOREF32)       \
	SLAKE_OPCODE_ENTRY(STOREF64)       \
	SLAKE_OPCODE_ENTRY(STOREBOOL)       \
	SLAKE_OPCODE_ENTRY(STORE)       \
                                    \
	SLAKE_OPCODE_ENTRY(LOBJ)        \
	SLAKE_OPCODE_ENTRY(LTYPE)       \
                                    \
	...
	SLAKE_OPCODE_ENTRY(LEXCEPT)     \
                                    \
	SLAKE_OPCODE_ENTRY(CASTI8)      \
	SLAKE_OPCODE_ENTRY(CASTI16)     \
	SLAKE_OPCODE_ENTRY(CASTI32)     \
	SLAKE_OPCODE_ENTRY(CASTI64)     \
	SLAKE_OPCODE_ENTRY(CASTISIZE)   \
	SLAKE_OPCODE_ENTRY(CASTU8)      \
	SLAKE_OPCODE_ENTRY(CASTU16)     \
	SLAKE_OPCODE_ENTRY(CASTU32)     \
	SLAKE_OPCODE_ENTRY(CASTU64)     \
	SLAKE_OPCODE_ENTRY(CASTUSIZE)   \
	SLAKE_OPCODE_ENTRY(CASTF32)     \
	SLAKE_OPCODE_ENTRY(CASTF64)     \
	SLAKE_OPCODE_ENTRY(CASTBOOL)    \
	SLAKE_OPCODE_ENTRY(CASTOBJ)     \
	SLAKE_OPCODE_ENTRY(CASTANY)     \
                                    \
