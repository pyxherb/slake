		...
		case ReferenceKind::LocalVarRef: {
			...
			switch (t.type_id) {
				...
				case TypeId::ISize:
					...
					value_out.as_isize = *(static_cast<const ssize_t *>(static_cast<const void *>(raw_data_ptr)));
				...
				case TypeId::USize:
					...
					value_out.as_usize = *(static_cast<const size_t *>(static_cast<const void *>(raw_data_ptr)));
