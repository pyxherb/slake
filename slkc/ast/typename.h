...
namespace slkc {
	...
	public:
		...
		SLKC_API VoidTypeNameNode(const VoidTypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API I8TypeNameNode(const I8TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API I16TypeNameNode(const I16TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API I32TypeNameNode(const I32TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API I64TypeNameNode(const I64TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API U8TypeNameNode(const U8TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API U16TypeNameNode(const U16TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API U32TypeNameNode(const U32TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API U64TypeNameNode(const U64TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API ISizeTypeNameNode(const ISizeTypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API USizeTypeNameNode(const USizeTypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API F32TypeNameNode(const F32TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API F64TypeNameNode(const F64TypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API StringTypeNameNode(const StringTypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API BoolTypeNameNode(const BoolTypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API ObjectTypeNameNode(const ObjectTypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API AnyTypeNameNode(const AnyTypeNameNode &rhs, peff::Alloc *selfAllocator, DuplicationContext &context);
	...
	public:
		...
		SLKC_API CustomTypeNameNode(const CustomTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API UnpackingTypeNameNode(const UnpackingTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API ArrayTypeNameNode(const ArrayTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API FnTypeNameNode(const FnTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API RefTypeNameNode(const RefTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API TempRefTypeNameNode(const TempRefTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API TupleTypeNameNode(const TupleTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API ParamTypeListTypeNameNode(const ParamTypeListTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API UnpackedParamsTypeNameNode(const UnpackedParamsTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
	...
	public:
		...
		SLKC_API UnpackedArgsTypeNameNode(const UnpackedArgsTypeNameNode &rhs, peff::Alloc *allocator, DuplicationContext &context, bool &succeededOut);
