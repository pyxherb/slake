...
SLKC_API TypeNameNode::TypeNameNode(const TypeNameNode &rhs, peff::Alloc *selfAllocator) : AstNode(rhs, selfAllocator), typeNameKind(rhs.typeNameKind), isFinal(rhs.isFinal) {
}
